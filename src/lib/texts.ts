...
const fallbackTexts: Record<string, Record<string, string>> = {
  ru: {
    ...
    "photo.generation_started": "✨ Принял! Генерирую фото, это займет немного времени...",
    "photo.generation_continue": "✨ Продолжаю генерацию...",
    ...
    "processing.done": "Готово! Вот ваш результат 🎉",
    "processing.error": "❌ Произошла ошибка при генерации.\n\nКредиты возвращены на баланс.\nПопробуй ещё раз: /start",
    "btn.cancel": "❌ Отмена",
    "btn.canceled": "Отменено",
    "btn.add_to_pack": "➕ Сохранить",
    "btn.change_style": "🎨 Изменить стиль",
    "btn.change_emotion": "😊 Изменить эмоцию",
    "btn.change_motion": "🏃 Изменить движение",
    "sticker.added_to_pack": "Фото сохранено! 🎉",
    "emotion.choose": "Выберите эмоцию для фото 😊",
    ...
    "style.custom_prompt": "✍️ Опишите желаемый стиль:",
    "error.no_stickers_added": "Нет сохранённых фото 🧩",
    ...
    "menu.help": "📷 Отправь фото — получи AI-фото\n💰 Каждое фото = 1 кредит\n🎨 Выбирай стили и настройки\n\nВопросы? @p2s_support_bot",
    "btn.add_text": "✏️ Текст (free)",
    "btn.toggle_border": "🔲 Обводка (free)",
    "text.prompt": "Введите текст для фото:",
    "progress.step1": "🔍 Анализирую фото... (1/5)",
    "progress.step2": "🎨 Подбираю стиль... (2/5)",
    "progress.step3": "✨ Генерирую изображение... (3/5)",
    "progress.step4": "🖼 Обрабатываю результат... (4/5)",
    "progress.step5": "📐 Оптимизирую размер... (5/5)",
    "progress.step6": "📐 Оптимизирую размер... (5/5)",
    "progress.step7": "📐 Финализирую... (5/5)",
    "sticker.pack_title": "Мои фото",
  ...
  en: {
    ...
    "photo.generation_started": "✨ Got it! Generating your photo, it will take a moment...",
    "photo.generation_continue": "✨ Continuing generation...",
    ...
    "processing.done": "Done! Here's your result 🎉",
    "processing.error": "❌ An error occurred during generation.\n\nCredits have been refunded.\nTry again: /start",
    "btn.cancel": "❌ Cancel",
    "btn.canceled": "Canceled",
    "btn.add_to_pack": "➕ Save",
    "btn.change_style": "🎨 Change style",
    "btn.change_emotion": "😊 Change emotion",
    "btn.change_motion": "🏃 Change pose",
    "sticker.added_to_pack": "Photo saved! 🎉",
    "emotion.choose": "Choose an emotion for the photo 😊",
    ...
    "style.custom_prompt": "✍️ Describe the desired style:",
    "error.no_stickers_added": "No saved photos 🧩",
    ...
    "menu.help": "📷 Send photo — get AI photo\n💰 Each photo = 1 credit\n🎨 Choose styles and settings\n\nQuestions? @p2s_support_bot",
    "btn.add_text": "✏️ Text (free)",
    "btn.toggle_border": "🔲 Border (free)",
    "text.prompt": "Enter text for the photo:",
    "progress.step1": "🔍 Analyzing photo... (1/5)",
    "progress.step2": "🎨 Selecting style... (2/5)",
    "progress.step3": "✨ Generating image... (3/5)",
    "progress.step4": "🖼 Processing result... (4/5)",
    "progress.step5": "📐 Optimizing size... (5/5)",
    "progress.step6": "📐 Optimizing size... (5/5)",
    "progress.step7": "📐 Finalizing... (5/5)",
    "sticker.pack_title": "My Photos",
