export const CLIENT_SOURCE_LABELS: Record<string, string> = {
  ...
  generaciya_foto: "Генерация фото", promptshot: "PromptShot", admin: "Админка", scout: "Scout",
  unknown: "Unknown",
};
export const CLIENT_SOURCE_COLORS: Record<string, string> = {
  ...
  promptshot: "#b45309", admin: "#db2777", scout: "#0f766e", unknown: "#71717a",
};
export const CLIENT_SOURCES_ORDER = [
  "site", "embed_stv", "extension_stv", "extension_lite",
  "foto_v_promt", "generaciya_foto", "promptshot", "admin", "scout", "unknown",
] as const;
