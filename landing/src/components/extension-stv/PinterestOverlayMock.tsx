...
export function PinterestOverlayMock() {
  return (
    <div className="mx-auto mt-12 w-full max-w-sm sm:mt-14">
      {/* Визуально ½ от исходного макета (768×~407): клип по высоте + scale, без «пустого» места в потоке */}
      <div className="relative mx-auto h-[210px] w-full overflow-hidden sm:h-[218px]">
        <div className="absolute left-1/2 top-0 w-[768px] max-w-[768px] origin-top -translate-x-1/2 scale-50">
              ...
              <div className="mx-auto grid max-w-2xl grid-cols-3 items-end gap-2 sm:gap-3">
                ...
                <PinChrome tall featured>
                  ...
                  <div className="absolute right-1.5 top-1.5 z-10 sm:right-2 sm:top-2">
                    <OverlayButtonMock
                      headline="Image To Prompt"
                      headlineClassName="text-[10px] leading-tight sm:text-[11px]"
                    />
                  </div>
                </PinChrome>
