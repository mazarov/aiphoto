...
import { FotoVPromtEmptyGuidance, FotoVPromtEmptyHero } from "./FotoVPromtEmptyState";
import {
  FVP_BORDER_CARD,
  FVP_BORDER_INPUT,
  FVP_FOCUS_RING,
            ...
            <>
              ...
              {panel === "empty" ? (
                ...
                >
                  ...
                  <FotoVPromtEmptyGuidance immersive />
                </label>
              ) : null}
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <div
              ...
              aria-hidden
            />
            <FotoVPromtEmptyHero immersive={false} />
            <span
            ...
            <FotoVPromtEmptyGuidance immersive={false} />
          </label>
        </div>
      ) : null}
