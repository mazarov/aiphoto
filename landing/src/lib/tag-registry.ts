...
export const TAG_REGISTRY: TagEntry[] = [
  // ── audience_tag ──
  { slug: "devushka", dimension: "audience_tag", labelRu: "Девушки", labelEn: "Women", urlPath: "/promty-dlya-foto-devushki", patterns: [/девушк|женщин|женск|леди|дама\b|модель\s+в\s+платье|в\s+юбке|макияж.*портрет|портрет.*макияж/i] },
  ...
  { slug: "studiynoe", dimension: "style_tag", labelRu: "Студийное", labelEn: "Studio", urlPath: "/stil/studiynoe", patterns: [/студийн|студи[яюей]\b|studio/i] },
  ...
  { slug: "s_cvetami", dimension: "object_tag", labelRu: "С цветами", labelEn: "With flowers", urlPath: "/s-cvetami", patterns: [/с цвет|букет|тюльпан|роз\b|пион|мимоз|ромашк|лепестк|сирен|цветоч|цвет[оа]к|лаванд|орхиде|гортенз/i] },
  ...
  { slug: "v_polnyy_rost", dimension: "object_tag", labelRu: "В полный рост", labelEn: "Full body", urlPath: "/v-polnyy-rost", patterns: [/в полный рост|во\s+весь\s+рост|в\s+рост\b/i] },
