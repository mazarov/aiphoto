...
export const TAG_REGISTRY: TagEntry[] = [
  ...
  { slug: "s_mamoy", dimension: "audience_tag", labelRu: "С мамой", labelEn: "With mother", urlPath: "/promty-dlya-foto-s-mamoy", patterns: [/с мамой|мам[аыуе](?![а-яё])/i] },
  { slug: "s_papoy", dimension: "audience_tag", labelRu: "С папой", labelEn: "With father", urlPath: "/promty-dlya-foto-s-papoy", patterns: [/с папой|пап[аыуе](?![а-яё])/i] },
