...
export const GENERACIYA_FOTO_SEO = {
  ...
  h1: "Сделать фото с помощью ИИ онлайн — без студии и камеры",
...
export const GENERACIYA_FOTO_REVIEWS = {
  ...
  items: [
    ...
    {
      name: "Катя Молькова",
      keywords: ["сделать трендовое фото ии", "сделать фото ии"],
      text: "Я не могу остановиться: хочется сделать трендовое фото ИИ во всех образах и локациях. Сделать фото ИИ здесь получается сразу — супер через PromptShot.",
    },
    {
      name: "Карина",
