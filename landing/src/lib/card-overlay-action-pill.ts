...
export const CARD_OVERLAY_ACTION_PILL =
  "inline-flex h-7 shrink-0 items-center justify-center gap-1 appearance-none rounded-full border-0 bg-black/15 px-2 leading-none shadow-none backdrop-blur-md transition-colors hover:bg-black/25";
