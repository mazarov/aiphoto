...
export const HOMEPAGE_FAQ: HomepageFaqItem[] = [
  ...
  },
  {
    ...
    aPlain:
      "Серию образов собирайте на странице «Промты для ИИ фотосессии»: выберите несколько луков, для каждого загрузите своё фото. Один кадр — в ленте на этой странице.",
  },
  {
    id: "best",
