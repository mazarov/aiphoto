...
export const FOTO_V_PROMT_WIDGET = {
  title: "Промт по фото",
  subtitle: "Загрузите снимок и получите текст.",
...
export const FOTO_V_PROMT_HOW = {
  ...
  subtitle:
    "Загрузите фото на этой странице. Расширение нужно, только если разбираете картинку на другом сайте.",
  steps: [
    "Загрузите фото в форму — получите промт из фото.",
    "Скопируйте текст или нажмите «Сгенерировать».",
    "Чтобы разобрать картинку на сайте, установите расширение AI Image Describer.",
  ] as const,
  promptSnippet:
    "Промт по картинке получается так же, как из фото: загрузили файл — получили текст. Можно вставить в Nano Banana или сразу сгенерировать кадр.",
} as const;
  ...
  items: [
    {
      ...
      a: "Это перевод снимка в текст для нейросети. Загрузите фото в форму на этой странице — получите промт.",
    },
    {
...
export const FOTO_V_PROMT_META = {
  ...
  description:
    "Загрузите фото и получите промт. 10 разборов в сутки без регистрации, дальше 1 токен. Текст можно скопировать или сразу сгенерировать кадр.",
