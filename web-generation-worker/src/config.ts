...
export const config = {
  ...
  replicateBaseUrl: (process.env.REPLICATE_BASE_URL || "").trim().replace(/\/+$/, ""),
  workerId:
  ...
  videoConcurrency: integer("WORKER_VIDEO_CONCURRENCY", 2, 1, 10),
  videoGlobalCap: integer("WORKER_VIDEO_GLOBAL_CAP", 8, 1, 20),
  videoPerUserCap: integer("WORKER_VIDEO_PER_USER_CAP", 1, 1, 3),
  videoLeaseSeconds: integer("WORKER_VIDEO_LEASE_SECONDS", 600, 60, 3600),
  videoPollMs: integer("WORKER_VIDEO_POLL_MS", 5000, 1000, 30000),
  videoTimeoutMs: integer("WORKER_VIDEO_TIMEOUT_MS", 480000, 60000, 900000),
