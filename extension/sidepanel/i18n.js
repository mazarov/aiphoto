...
const STRINGS = {
  ru: {
    ...
    section_photos_compare: "Ваше фото и референс",
    compare_col_your_photo: "Ваше фото",
    compare_col_reference: "Стиль референса",
    compare_photo_empty: "Выберите файл ниже",
  ...
  de: {
    ...
    section_photos_compare: "Dein Foto & Referenz",
    compare_col_your_photo: "Dein Foto",
    compare_col_reference: "Referenz-Stil",
    compare_photo_empty: "Datei unten wählen",
