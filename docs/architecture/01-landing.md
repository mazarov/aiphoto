...
> Последнее обновление: 2026-08-14 (**mobile card prompt overlay glass:** полноэкранный промпт снова на той же подложке, что чипы — `bg-black/48` + `backdrop-blur` + `MOBILE_FS_*`; непрозрачный `zinc-950` убран.)
>
