...
> Последнее обновление: 2026-08-14 (**mobile card prompt overlay:** нижний glass-бар — **«Промпт» + LexyGPT**; клик «Промпт» открывает полноэкранный экран с текстом, крестик справа сверху и «Скопировать промпт» внизу. Чип «Посмотреть промт» снят.)
>
