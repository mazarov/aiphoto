...
> Последнее обновление: 2026-09-09 (**hero-карусель alt:** живые плитки `GeneraciyaFotoHeroCarousel` чередуют `img alt` из SEO H1 и explorer-H2 (`headingAltSlots` / `headingAltSlotsFromSeo`), плюс короткий хук карточки. Копия marquee `b` с пустым alt. `aria-label` ссылки — имя карточки. Catalog hub и `/`. Листинг под поиском не меняли. HowTo/FAQ в очередь не входят.)
>
