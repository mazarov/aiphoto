...
> Последнее обновление: 2026-08-28 (**AI-фотосессия креативность:** клик «Сделать фотосессию» открывает правый rail — ползунок, живая подсказка (нейтральнее / нейтрально / смелее / невероятные сюжеты), «Выйти», «Создать ИИ фотосессию». UI 50 = temp 0.5, 100 = temp 2.0. Worker меняет brief планера; I2I-модель температуру не видит.
>
> Последнее обновление: 2026-08-28 (**AI-фотосессия history chrome:** `/generations` — сетка 4 кадров + шильд «Фотосессия». Клик → обычный result chrome (кадр 1 + rail) и плёнка выбора кадра. 4 URL идут в `seedCompletedResult` сразу из списка. Follow-up I2I/video с photoshoot-родителя берёт тайл, не лист. Кнопка «Сделать фотосессию» на готовой фотосессии остаётся; enqueue разрешён, если есть 4 тайла (SQL `226`).
>
