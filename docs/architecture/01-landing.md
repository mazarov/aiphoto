...
>
> Последнее обновление: 2026-08-26 (**`/generaciya-foto` без `#seo-opisanie`:** keyword-body ~4500 снят. Title/short и Facee-блоки остаются. Порядок: hero/starter → темы → тренды → галерея → инструменты → 150+ → идеи → HowTo → отзывы → что умеет → модели → FAQ → CTA. Спека `docs/26-08-sdelat-foto-ii.md`.
>
