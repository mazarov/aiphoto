...
> Последнее обновление: 2026-03-22 (**`assembleVibeFinalPrompt`**, dual-image: после **CRITICAL RULES** — короткий блок **LAST** про видимый hair/makeup transfer, если в теле есть маркеры grooming)
