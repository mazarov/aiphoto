...
| `/api/generation-config` | Конфиг генерации; `modality=image` (default) или `video`. Video: модели из `video_models`, 9:16/16:9, 4 сек, 720p, `enabled` из `video_animate_enabled`. SSOT `lib/generation/image-options.ts` |
