...
/pricing                → Приватный preview только для `azarov.maxim@gmail.com` (остальным 404): пакеты Basic, Standard, Pro, Ultimate; до ЮKassa кнопка показывает non-blocking статус «Оплата появится скоро»
