...
> Последнее обновление: 2026-03-22 (**dual multimodal:** **`VIBE_IMAGE_PART_LABEL_SUBJECT`** — явное разделение: с B идентичность + цвет волос; укладка/мейк с A, если в тексте есть секции transfer; **`assembleVibeFinalPrompt`**: **LAST** при grooming)
