...
>
> Последнее обновление: 2026-08-31 (**хаб ИИ-фотосессии → `/ii-fotosessiya`:** коммерческий кластер «ии фотосессия / по фото». Title `ИИ фотосессия по фото онлайн`, H1 `ИИ фотосессия по фото`. L2 `/ii-fotosessiya/{slug}`. 301 `/promty-dlya-ii-fotosessii` и `/:slug` + `/promty-dlya-fotosessii` → новый хаб. Спека `docs/31-08-ii-fotosessiya.md`.
>
...
/ii-fotosessiya → Хаб коммерческого кластера «ии фотосессия / по фото» (серия из одного снимка, не каталог промтов и не «сделать фото ИИ»). Title `ИИ фотосессия по фото онлайн`, H1 `ИИ фотосессия по фото`. Каркас: hero + карусель фотосессий + коллажи L2 + HowTo + галерея + тарифы `#tarify` + FAQ. Copy SSOT `promty-dlya-ii-fotosessii-seo-copy.ts`, роуты `promty-dlya-ii-fotosessii-cluster.ts`. L2 `/ii-fotosessiya/{slug}` — тот же каркас, Title/H1 коммерческие (`Женская ИИ фотосессия`, `Парная ИИ фотосессия`, …). Sitemap хаб 0.9, дети от 8 карточек 0.85. 301 `/promty-dlya-ii-fotosessii` + `/:slug` и `/promty-dlya-fotosessii` → хаб. Спека `docs/31-08-ii-fotosessiya.md`.
