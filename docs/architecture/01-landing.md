...
> Последнее обновление: 2026-03-23 (extension: до 4 пользовательских фото → `photoStoragePaths`, `docs/23-03-stv-multi-user-photos-ui.md`; legacy vibe chain — см. строку от 2026-03-22 и `docs/22-03-stv-single-generation-flow.md`)
